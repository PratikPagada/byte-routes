...
* Below you can find an API call to a sandbox environment of our logistics tool. I have created some dummy routes for 2018-06-01. No other day has a route right now
* Use React Native to expose the output of this query. The query outputs a list of routes with each having a list of stops and driverName
